export const articles = [
...

    {
      ...
      <p>Osoby starsze i chorzy potrzebują 1,0–1,5 g/kg, sportowcy zaś 1,4–2,0 g/kg (a przy deficycie nawet 2,3–3,1 g/kg).</p>
    ...
    <p class="text-sm italic">Źródło: Broszura „Czy wiesz, ile potrzebujesz węglowodanów?”, Instytut Żywności i Żywienia, Warszawa 2019 :contentReference[oaicite:6]{index=6}</p>
  `
    },
    ...
    <p class="text-sm italic">Źródło: Broszura „Czy wiesz, ile potrzebujesz tłuszczów?”, Instytut Żywności i Żywienia, Warszawa 2019 :contentReference[oaicite:15]{index=15}</p>
  `
    },
    ...
    <p><strong>Harris–Benedict:</strong><br>
       ...
       Mężczyźni: 66,5 + (13,75 × masa [kg]) + (5,003 × wzrost [cm]) – (6,775 × wiek) :contentReference[oaicite:13]{index=13}</p>
  ...
  `
    ...
    <ul>
      ...
      <li><strong>Błonnik</strong> – wspiera perystaltykę i równowagę mikroflory; cel: 25–30 g/dzień :contentReference[oaicite:6]{index=6}.</li>
    </ul>

    <h2>2. Witaminy</h2>
    <ul>
      <li><strong>Rozpuszczalne w wodzie</strong> (B, C) – nie magazynowane; trzeba jeść codziennie (warzywa, owoce, pełne ziarna) :contentReference[oaicite:7]{index=7}.</li>
      <li><strong>Rozpuszczalne w tłuszczach</strong> (A, D, E, K) – magazynowane w wątrobie; dbaj o umiarkowaną podaż, unikaj nadmiaru :contentReference[oaicite:8]{index=8}.</li>
    </ul>
    ...
    <ul>
      ...
      <li><strong>Cynk, magnez, jod, selen</strong> – kluczowe dla metabolizmu, odporności i funkcji tarczycy :contentReference[oaicite:9]{index=9}.</li>
    </ul>
  ...
  `
    ...
    {
        id: 'bmi-wskaznik',
        title: 'Wskaźnik BMI – co to jest i jak interpretować',
        icon: '⚖️',
        color: 'bg-purple-500',
        content: `
    <p>Wskaźnik masy ciała (BMI) to prosty sposób na ocenę, czy Twoja masa ciała jest odpowiednia w stosunku do wzrostu. Oblicza się go, dzieląc wagę (kg) przez kwadrat wzrostu (m²). Pozwala to szybko sprawdzić, czy waga mieści się w granicach uznawanych za zdrowe, czy może wymaga uwagi dietetyka lub lekarza. :contentReference[oaicite:0]{index=0}</p>
    ...
    <p class="text-sm italic text-gray-500">
      ...
      <ul>
        ...
        <li>R. Stupnicki, <em>Relacje wagowo-wzrostowe i stosowanie wskaźnika BMI u dzieci i młodzieży</em>, www.wskfit.pl [dostęp 12.2024].</li>
  ...
  `
...

    {
        ...
        color: 'bg-yellow-600',
        content: `
    <p>Wiedza o tym, co kryje się za informacjami na opakowaniu, to fundament świadomego wyboru produktów i zdrowych nawyków żywieniowych. Czytanie etykiet pomaga unikać nadmiaru cukrów, soli czy tłuszczów nasyconych, a także wybierać produkty wolne od niepożądanych dodatków. :contentReference[oaicite:0]{index=0}</p>
